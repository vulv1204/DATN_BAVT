                            ...
                            <div class="cart-table table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cartItems as $item)
                                            <tr>
                                                ...
                                                <td class="pro-title"><a
                                                        href="#">{{ $item->productSize->product->name }}</a></td>
                                                <td class="pro-size">{{ $item->productSize->variant }}</td>
                                                <td class="pro-price">
                                                    <span>{{ number_format($item->productSize->product->price + $item->productSize->price, 0, ',', '.') }}
                                                        VND</span>
                                                </td>
                                            ...
                                            @php
                                                $grandTotal +=
                                                    ($item->productSize->product->price + $item->productSize->price) *
                                                    $item->quantity;
                                            @endphp
                                        @endforeach
                                        ...
                                        {{-- <tr>
                                            <td class="pro-thumbnail"><a href="#"><img class="img-fluid"
                                                        src="assets/img/product/product-1.jpg" alt="Product" /></a>
                                            </td>
                                            <td class="pro-title"><a href="#"></a></td>
                            ...
                            <div class="cart-update-option d-block d-md-flex justify-content-between">
                                <div class="apply-coupon-wrapper">
                                    <form action="#" method="post" class="d-block d-md-flex">
                                        <input type="text" placeholder="Nhập voucher..." required />
                                        ...
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td class="cart-total" id="grandTotal">
                                                    {{ number_format($grandTotal, 0, ',', '.') }} VND</td>
                                            </tr>
                                            <tr>
                                                <td>Shipping</td>
                                                <td>$70</td>
